...
#define STRING_CONFIG_H_AUTHOR "Ax Smith-Laffin - AxMod 3D Print" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 63.02
  #define  DEFAULT_bedKi 11.45
  #define  DEFAULT_bedKd 86.72
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 76  // Y offset: -front +behind [the nozzle]
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 66   // Y point for Z homing when homing all axis (G28).
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,769.54,292.00}  // default steps per unit for Ultimaker
