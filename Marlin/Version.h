 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "AxMod FB2020"

  /**
   * Verbose version identifier which should contain a reference to the location
   * from where the binary was downloaded or the source code was compiled.
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION "AxMod Box Mods FB2020 Firmware"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2016-10-27 21:10"
   ...
   */
  #define WEBSITE_URL "www.axmod.co.uk"
